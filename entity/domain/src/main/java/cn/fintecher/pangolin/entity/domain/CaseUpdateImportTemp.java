 ...
 */
@Data
@Document(indexName = "case_update_import_temp", type = "case_update_import_temp", shards = 1, replicas = 0)
@ApiModel(value = "BaseCaseAllImportExcelTemp", description = "案件金额更新导入")
public class CaseUpdateImportTemp {
