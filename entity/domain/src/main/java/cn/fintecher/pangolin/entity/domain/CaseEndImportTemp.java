 ...
 */
@Data
@Document(indexName = "case_end_import_temp", type = "case_end_import_temp", shards = 1, replicas = 0)
@ApiModel(value = "CaseEndImportTemp", description = "案件停催导入")
public class CaseEndImportTemp {
