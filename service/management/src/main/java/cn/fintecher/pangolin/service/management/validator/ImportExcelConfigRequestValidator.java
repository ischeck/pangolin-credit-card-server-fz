 ...
 */
@Component("importExcelConfigRequestValidator")
public class ImportExcelConfigRequestValidator implements Validator {
    ...
    public boolean supports(Class<?> aClass) {
        return ImportExcelConfigRequestValidator.class.isAssignableFrom(aClass);
    }
